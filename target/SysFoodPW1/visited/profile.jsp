                    ...
                    <%--<div class="card-post">--%>
                        <%--<div class="row">--%>
                            <%--<form method="post" action="/front?action=SalvarPublicacao" enctype="multipart/form-data">--%>
                                ...
                                <%--&lt;%&ndash;<textarea class="form-control" name="conteudo" id="" cols="30" rows="10"></textarea>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<br>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<input class="form-control" name="fotoPublicacao" type="file">&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<br>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<input class="form-control" type="submit" value="Post">&ndash;%&gt;--%>
                                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                                <%--<li class="add-post">--%>
                                ...
                                <%--<div class="image-upload">--%>
                                    <%--<label for="file-input">--%>
                                        <%--&lt;%&ndash;<img src="https://placehold.it/100/000000/ffffff?text=UPLOAD" style="pointer-events: none"/>&ndash;%&gt;--%>
